          ...
          <form className="space-y-4" action={login}>
            <div>
              ...
              <input 
                type="text" 
                id="email" 
                className="w-full px-3 py-2 border font-semibold border-neutral-300 rounded-md focus:outline-none focus:ring-2 focus:ring-neutral-800" 
                placeholder="Enter your email" 
                value={email}
                onChange={(e) => setEmail(e.target.value)}
              />
              {formValidated === 'email' && <p className="text-red-500 text-xs mt-1">Field is required</p>}
            </div>
            <div>
              ...
              {formValidated === 'password' && <p className="text-red-500 text-xs mt-1">Field is required</p>}
            </div>
            <div className="flex items-center">
              <input 
                type="checkbox" 
            ...
            <button
              type="submit"
              id="login-button"
              className="w-full bg-neutral-800 font-semibold cursor-pointer text-white py-3 px-4 rounded-md hover:bg-neutral-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-800"
            >
              Sign in
            </button>
          </form>
